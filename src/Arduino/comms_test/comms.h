...
class Comms
{
    ...
    private:
        ...
        uint32_t configure_DATARATE(int bitrate, int cicdec, int fskmul);
        void configure_TMGGAIN(uint32_t fskmul, uint32_t datarate, int tmgcorrfrac);
        void configure_AGCATTACK(int bitrate, uint8_t modValue);
        void configure_AGCDECAY(int bitrate, uint8_t modValue);
        void configure_PHASEGAIN(uint8_t modValue);
        void configure_FREQGAIN(uint8_t modValue);
